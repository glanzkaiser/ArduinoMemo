...
{
  Serial.begin(9600);
  Serial.println("BMP280, Vibration Motor and ST7789 Test");
...
void loop()
{
  ...
  tft.setTextColor(ST77XX_WHITE);
  tft.print("L'altitude: ");
  tft.setTextColor(ST77XX_GREEN);
  tft.print(bmp.readAltitude(975.7));
  tft.print(" m");
  tft.println(" ");

  if(bmp.readAltitude(975.7) > 1000)
  {
  analogWrite(motorPin, 255);
  delay(3300);
  tft.setCursor(0, 166);
  tft.setTextColor(ST77XX_WHITE);
  tft.print("L'altitude est plus de 1000 m");
  }
  else
  {
  ...
  tft.setCursor(0, 166);
  tft.setTextColor(ST77XX_WHITE);
  tft.print("L'altitude est moins de 1000 m");
  }

...
def animate(i, dataList, ser):
    ...
    ax.set_ylim([26, 28])                              # Set Y axis limit of plot
    ax.set_title("Arduino Data from BMP280")                        # Set title of figure
    ax.set_ylabel("Temperature (degree Celcius)")                              # Set title of y axis 
...
ser = serial.Serial("/dev/ttyACM0", 9600)                       # Establish Serial object with COM port and BAUD rate to match Arduino Port/rate

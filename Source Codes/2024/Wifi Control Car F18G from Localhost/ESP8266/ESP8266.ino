...
void setup(){
  Serial.begin(9600);
   ...
   while (WiFi.status() != WL_CONNECTED) 
   {
     ...
     webpage+="<center><h1> F18G WiFi Control Car with Arduino Uno WiFi R3 </h1></center>";
     webpage+= "<br></br>";
     ...
     webpage+= "<center><a href=\"forward\"\"><button class='button button1'>Forward</button></a>";
     webpage+= "<a href=\"fastforward\"\"><button class='button button1'>Accelerate</button></a></p><br></br>";
     webpage+= "<a href=\"left\"\"><button class='button button1'>Turn Left</button></a>";
     webpage+= "<a href=\"right\"\"><button class='button button1'>Turn Right</button></a></pr><br></br>";
     webpage+= "<a href=\"reverse\"\"><button class='button button1'>Reverse</button></a>";
     webpage+= "<a href=\"stop\"\"><button class='button button1'>Stop</button></a></pr></center>";
     webpage+= "</head>";   
